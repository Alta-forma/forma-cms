...
?>
<?php echo fx_panel_header('robot', 'Agent API', 'Let Cursor and AI tools manage this site over HTTPS'); ?>
...
<div class="settings-card">
    ...
    <p class="card-sub">Grant only the scopes the agent actually needs.</p>
